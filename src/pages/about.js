  ...
  <Layout>
    <div className={styles.textCenter}>
      <div class="centre-div">
        <h3 class="fell">What we offer</h3>
            <p>Unique Vacation Ideas: Explore authentic travel experiences around the globe. From family adventures to culinary delights and thrilling escapades, they curate bespoke itineraries that cater to your desires.
